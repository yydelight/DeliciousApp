	...
	export default {
		...
		data () {
			return {
				...
				menus:[{
				  title:"美食随手拍",
				  src:"../../assets/menuImg/home_topic.png"
				},{
				  title:"厨艺交流",
				  src:"../../assets/menuImg/home_menu.png"
				},{
				  title:"烘焙圈",
				  src:"../../assets/menuImg/home_video.png"
				},{
				  title:"妈妈派",
				  src:"../../assets/menuImg/home_event.png"
				},{
				  title:"全部小组",
				  src:"../../assets/menuImg/home_welfare.png"
				}],
				news : [],
				error:''
